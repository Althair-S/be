...
const OrderSchema = new Schema<Order>({
  ...
  status    : { type : Schema.Types.String, enum : [OrderStatus.PENDING, OrderStatus.COMPLETED, OrderStatus.CANCELLED], default : OrderStatus.PENDING},
...
}, { timestamps: true }).index({orderId : "text"});
